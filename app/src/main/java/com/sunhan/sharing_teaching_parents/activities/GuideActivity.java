...
public class GuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isFirstUse = sharedPreferences.getBoolean("isFirstUse", true);//(key,若无数据需要赋的值)

        System.out.println("输出isFirstUse的值:" + isFirstUse);

        if (!isFirstUse) {
            System.out.println("直接跳转到loading界面");
